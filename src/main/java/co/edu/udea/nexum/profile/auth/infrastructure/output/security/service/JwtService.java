package co.edu.udea.nexum.profile.auth.infrastructure.output.security.service;
...
public class JwtService {
    ...
    public <V> V getClaimFromKey(String token, String key, Class<V> clazz) {
        return getClaim(token, claims -> claims.get(key, clazz));
    }
