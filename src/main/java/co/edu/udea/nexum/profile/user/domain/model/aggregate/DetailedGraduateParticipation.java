...
@Generated
public class DetailedGraduateParticipation implements Model<Long> {

    private Long id;
    private List<InnovationProcessType> participatedInnovationProcesses;
    ...
    @Generated
    private DetailedGraduateParticipation(DetailedGraduateParticipationBuilder builder) {
        this.id = builder.id;
        this.participatedInnovationProcesses = builder.participatedInnovationProcesses;
    ...
    public static DetailedGraduateParticipationBuilder builder() {
        return new DetailedGraduateParticipationBuilder();
    }
    ...
    public List<InnovationProcessType> getParticipatedInnovationProcesses() {
        return participatedInnovationProcesses;
    }

    public void setParticipatedInnovationProcesses(List<InnovationProcessType> participatedInnovationProcesses) {
        this.participatedInnovationProcesses = participatedInnovationProcesses;
    }
    ...
    public static class DetailedGraduateParticipationBuilder implements BaseBuilder<DetailedGraduateParticipation> {
        private Long id;
        private List<InnovationProcessType> participatedInnovationProcesses;
        private List<String> continuousEducationInterests;
        private Boolean willingToBeSpeaker;
        ...
        public DetailedGraduateParticipationBuilder id(Long id) {
            this.id = id;
            return this;
        }

        public DetailedGraduateParticipationBuilder participatedInnovationProcesses(List<InnovationProcessType> processes) {
            this.participatedInnovationProcesses = processes;
            return this;
        }

        public DetailedGraduateParticipationBuilder continuousEducationInterests(List<String> interests) {
            this.continuousEducationInterests = interests;
            return this;
        }

        public DetailedGraduateParticipationBuilder willingToBeSpeaker(Boolean value) {
            this.willingToBeSpeaker = value;
            return this;
        }

        public DetailedGraduateParticipationBuilder willingToBeProfessor(Boolean value) {
            this.willingToBeProfessor = value;
            return this;
        }

        public DetailedGraduateParticipationBuilder willingToTeachNonFormalEducation(Boolean value) {
            this.willingToTeachNonFormalEducation = value;
            return this;
        }

        public DetailedGraduateParticipationBuilder willingToBePostgraduateStudent(Boolean value) {
            this.willingToBePostgraduateStudent = value;
            return this;
        }

        public DetailedGraduateParticipationBuilder willingToBeNonFormalStudent(Boolean value) {
            this.willingToBeNonFormalStudent = value;
            return this;
        }

        public DetailedGraduateParticipationBuilder willingToBeGraduateRepresentative(Boolean value) {
            this.willingToBeGraduateRepresentative = value;
            return this;
        }

        public DetailedGraduateParticipationBuilder willingToAttendAlumniMeetings(Boolean value) {
            this.willingToAttendAlumniMeetings = value;
            return this;
        }

        public DetailedGraduateParticipationBuilder willingToParticipateInAlumniActivities(Boolean value) {
            this.willingToParticipateInAlumniActivities = value;
            return this;
        }

        public DetailedGraduateParticipationBuilder creationDate(LocalDateTime creationDate) {
            this.creationDate = creationDate;
            return this;
        }

        public DetailedGraduateParticipationBuilder lastUpdate(LocalDateTime lastUpdate) {
            this.lastUpdate = lastUpdate;
            return this;
        }

        @Override
        public DetailedGraduateParticipation build() {
            return new DetailedGraduateParticipation(this);
        }
    }
}
